...
Route::middleware(['auth', 'role:2'])->group(function () {
    ...
    Route::group(['prefix' => 'entrenador/partidos'], function () {
        ...
        Route::put('/update/{id}', [PartidosController::class, 'update'])->name('partidos.update');

        Route::get('entrenador/partidos/{id}/finalizar', [PartidosController::class, 'finalizar'])->name('partidos.finalizar');
        Route::post('entrenador/partidos/{id}/finalizar', [PartidosController::class, 'procesarFinalizacion'])->name('partidos.procesarFinalizacion');
